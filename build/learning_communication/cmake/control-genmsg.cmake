...
message(STATUS "control: 2 messages, 1 services")

set(MSG_I_FLAGS "-Icontrol:/home/xsm/control/src/learning_communication/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control" "/home/xsm/control/src/learning_communication/srv/AddTwoInts.srv" ""
)

get_filename_component(_filename "/home/xsm/control/src/learning_communication/msg/bianshi.msg" NAME_WE)
add_custom_target(_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control" "/home/xsm/control/src/learning_communication/msg/bianshi.msg" ""
)

get_filename_component(_filename "/home/xsm/control/src/learning_communication/msg/force_send.msg" NAME_WE)
add_custom_target(_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control" "/home/xsm/control/src/learning_communication/msg/force_send.msg" ""
)
