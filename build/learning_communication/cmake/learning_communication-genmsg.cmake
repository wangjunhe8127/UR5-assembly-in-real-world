...
message(STATUS "learning_communication: 2 messages, 1 services")

set(MSG_I_FLAGS "-Ilearning_communication:/home/xsm/control/src/learning_communication/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xsm/control/src/learning_communication/srv/AddTwoInts.srv" NAME_WE)
add_custom_target(_learning_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_communication" "/home/xsm/control/src/learning_communication/srv/AddTwoInts.srv" ""
)

get_filename_component(_filename "/home/xsm/control/src/learning_communication/msg/bianshi.msg" NAME_WE)
add_custom_target(_learning_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_communication" "/home/xsm/control/src/learning_communication/msg/bianshi.msg" ""
)

get_filename_component(_filename "/home/xsm/control/src/learning_communication/msg/force_send.msg" NAME_WE)
add_custom_target(_learning_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_communication" "/home/xsm/control/src/learning_communication/msg/force_send.msg" ""
)
...
_generate_srv_cpp(learning_communication
  "/home/xsm/control/src/learning_communication/srv/AddTwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/learning_communication
)
